...
public class MesajListesiFragment extends Fragment {
    ...
    private RecyclerView mSonMesajlarRecyclerView;
    ...
    public static MesajListesiFragment newInstance(Long id, boolean hoca_mi) {

        Bundle args = new Bundle();
        args.putLong(EXTRA_ID, id);
        args.putBoolean(EXTRA_HOCA_MI, hoca_mi);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mHoca_mi = getArguments().getBoolean(EXTRA_HOCA_MI);
    ...
    private class SonKonusmaMesajlariAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        class MesajViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                Intent intent = MesajlarActivity.newIntent(getActivity(),mSonMesaj);
            ...
            public void bind(SonKonusmaMesaji sonKonusmaMesaji) {
                ...
                mSonMesajTextView.setText(sonKonusmaMesaji.getMesaj_icerik());
